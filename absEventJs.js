const absurdEvents = [
  ...
  "Metsästäjä-kokoaja eksyy kivi-aikaan ja yrittää kouluttaa mammutin lemmikiksi.",
  "Einstein kirjoittaa väärän kaavan ja saa koko fysiikan hajoamaan.",
  "Rooman valtakunnan viimeinen keisari yrittää käynnistää WiFi:n, mutta epäonnistuu.",
