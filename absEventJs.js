const absurdEvents = [
  ...
  "Ärsyynnyt",
  "Istut bussissa 725 826 tuntia putkeen, ilman puhelintasi.",
  "Mittanauha osuu peukalosi sijasta etusormeesi",
  "Puu putoaa talosi viereen.",
  "Pyöräytä hahmopyörää.",
  "Kirjoitat vihdoin yhden sanan oikein... Lentokonesuihkuturbiinimoottoriapumekaanikkoyliupseerioppilas.",
  "Kirjoitat postikortin.",
  "Saat uuden murteen alueelta, jonka murretta et ennestään tunne.",
  "Putoat katuojaan.",
  "Saat 726 516 187 jezopeli-fani-t-paitaa.",
  "Saat 15 kultaharkkoa, jotka kaikki ovat 726 826 062 nanogrammaa.",
  "Yksi.",
  "Kaksi.",
  "Kolme.",
  "Neljä.",
  "Saat päättää mitä saat, ja miten paljon.",
  "Saat repun!",
  "Saat paketin, jota et saa avata itse.",
  "Kirjoitat autiotalon seinään, ja sinut pidätetään unissasi.",
  "Pelaat testimato-testiä ja saat huonoimman mahdollisen lopputuloksen.",
  "Lennät taas",
  "Muutut juppihippipukariksi, ja vaihdat paikkaa.",
  "Ja sä lennät taas.",
  "Katuoja jahtaa sinua.",
  "Luet ABCKIRIA 50 sentillä läpi, mutta luulet, ettei Q ole mahdollinen.",
  "Asiattomilta pääsy kielletty!",
  "Saat puutarhurin diplomin.",
  "Saat 82 pensasta.",
  "Teet pilkkuvirheen esseessä.",
  "Myyt jalometalliharkkoja 725 kappaletta, 85% liian halvalla.",
  "Puunkanto irtoaa maasta, ja jahtaa sinua.",
  "Ja sä lennät taaskin!",
  "Peräkärry irtoaa kesken matkan ja tekee sinusta lesken.",
  "Bussin ruokahyllyjuttu putoaa jaloillesi.",
  ];
